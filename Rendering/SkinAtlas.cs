...
/// uploaded from the decoded <see cref="WszSkin"/> bitmaps.
///
...
public sealed class SkinAtlas : IDisposable
{
    ...
    public void UploadSkin(WinampSkinEngine.Skin.WszSkin skin)
    {
        ...
        AppLogger.Info($"[SkinAtlas] Upload complete — {uploaded}/14 bitmaps uploaded, {_bitmaps.Count} total in atlas");
    }
