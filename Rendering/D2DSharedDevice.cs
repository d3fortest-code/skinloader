...
public sealed class D2DSharedDevice : IDisposable
{
    ...
    public D2DWindowSurface CreateWindowSurface(IntPtr hwnd, int width, int height)
    {
        ObjectDisposedException.ThrowIf(_disposed, this);
        AppLogger.Info($"[D2DSharedDevice] Creating window surface: hwnd={hwnd}, {width}x{height}");
        var surface = new D2DWindowSurface(D3DDevice, DXGIFactory, D2DDevice, hwnd, width, height);
